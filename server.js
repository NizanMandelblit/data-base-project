...
app.post("/search", function (req, res) {
    ...
    var distance_hotels= 'select ST_Distance_Sphere(point('+hotels.latitude+','+hotels.longitude+'),point('+restaurants.latitude+','+ restaurants.longitude+'))'
    //(hotels.latitude-restaurants.latitude)+(hotels.longitude-restaurants.longitude)"
